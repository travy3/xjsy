    ...
    $('#user-datagrid-${uuid}').datagrid({
        columns: [
            ...
            },
            {
                ...
                width: 150,
                render: function(value) {
                    return '<a href="${ctx}/sys/user/edit/'+value+'" data-toggle="dialog" data-width="830" data-height="230"data-mask="true" data-type="POST" data-title="账号修改" class="btn btn-blue">修改</a>'
                },
                edit:false,
                add:false
            }
...
<div class="bjui-pageContent tableContent">
    <div style="height:100%; width:100%;">
        <table id="user-datagrid-${uuid}" data-width="100%" class="table table-bordered">
        </table>
        <br>
    </div>
</div>
