        ...
        <div id="bjui-sidebar">
            ...
            <div class="panel-group panel-main" data-toggle="accordion" id="bjui-accordionmenu" data-heightbox="#bjui-sidebar" data-offsety="26">
                ...
                <div class="panel-heading panelContent">
                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#bjui-accordionmenu" href="#bjui-collapse-${menu.id}" class=""><i class="fa fa-caret-square-o-right"></i>&nbsp;${menu.name}</a></h4>
                </div>
                <div id="bjui-collapse-${menu.id}" class="panel-collapse panelContent collapse">
                        ...
                        <ul id="bjui-tree-${menu.id}" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-expand-level="2">
                            <c:forEach items="${menuList}" var="menuChild">
                                <c:if test="${menuChild.pid eq menu.id}">
                                    ...
                                    <li data-id="${menuChild.id}" data-pid="${menuChild.pid}" data-url="${ctx}${menuChild.href}" data-tabid="${menuChild.id}" data-faicon="caret-right">${itemmenu.name}</li>
                                </c:if>
                            </c:forEach>
                        </ul>
                    </div>
