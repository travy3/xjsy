...
<script type="text/javascript">
    $('#role-datagrid-${uuid}').datagrid({
        ...
        toolbarCustom 	: 	'<a href="${ctx}/sys/role/manage" data-toggle="dialog" data-id="" data-width="830" data-height="230" data-mask="true" data-type="POST" data-title="新增账号" class="btn btn-blue">新增角色</a>  ',//[可选] 自定义的html内容或jQuery DOM对象，支持带返回值函数。
