...
<script type="text/javascript">
    $('#user-datagrid-json').datagrid({
        ...
        toolbarCustom 	: 	'<a href="${ctx}/cus/1/add" data-toggle="dialog" data-id="" data-width="830" data-height="230" data-mask="true" data-type="POST" data-title="新增账号" class="btn btn-blue">新增账号</a>  ',//[可选] 自定义的html内容或jQuery DOM对象，支持带返回值函数。
