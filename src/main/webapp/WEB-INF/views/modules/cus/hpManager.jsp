        ...
        <table class="table table-condensed table-hover" width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="name" id="j_customer_name" value="${customer.name}" data-rule="required" size="15" readonly>
                </td>
                <td colspan="2">
                    <label for="j_customer_school" class="control-label x85">学校：</label>
                    <input type="text" name="school" id="j_customer_school" value="${customer.school}" size="30" readonly>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <c:choose>
                        <c:when test="${customer.sex eq 1}">
                            <input type="radio" name="sex" id="j_customer_sex1" data-toggle="icheck" value="1" checked="checked" data-label="男&nbsp;&nbsp;" readonly>
                            <input type="radio" name="sex" id="j_customer_sex2" data-toggle="icheck" value="0" data-label="女" readonly>
                        </c:when>
                        <c:otherwise>
                            <input type="radio" name="sex" id="j_customer_sex1" data-toggle="icheck" value="1" checked="checked"  data-label="男&nbsp;&nbsp;" readonly>
                            <input type="radio" name="sex" id="j_customer_sex2" data-toggle="icheck" value="0"  data-label="女" readonly>
                ...
                <td>
                    ...
                    <input type="text" name="birthday" id="j_customer_birthday" value="${sdfBirthday}" data-toggle="datepicker" data-rule="required;date" size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_eyeglassesSightR" class="control-label x85">戴镜度数R：</label>
                    <input type="text" name="eyeglassesSightR" id="j_customer_eyeglassesSightR" value="${customer.eyeglassesSightR}" data-rule="required" size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_eyeglassesSightL" class="control-label x85">戴镜度数L：</label>
                    <input type="text" name="eyeglassesSightL" id="j_customer_eyeglassesSightL" value="${customer.eyeglassesSightL}" data-rule="required" size="15" readonly>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <label for="j_customer_telephone" class="control-label x85">手机：</label>
                    <input type="text" name="telephone" id="j_customer_telephone" value="${customer.telephone}" data-rule="required;mobile" size="30" readonly>
                </td>
                <td>
                    <label for="j_customer_nakedEyeSightR" class="control-label x85">裸眼视力R：</label>
                    <input type="text" name="nakedEyeSightR" id="j_customer_nakedEyeSightR" value="${customer.nakedEyeSightR}" data-rule="required" size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_nakedEyeSightL" class="control-label x85">裸眼视力L：</label>
                    <input type="text" name="nakedEyeSightL" id="j_customer_nakedEyeSightL" value="${customer.nakedEyeSightL}" data-rule="required" size="15" readonly>
                </td>
                <td></td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="text" name="glassesTime" id="j_customer_glassesTime" value="${customer.glassesTime}" data-rule="required" size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_address" class="control-label x85">家庭住址：</label>
                    <input type="text" name="address" id="j_customer_address" value="${customer.address}" size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_recoverEyeSightR" class="control-label x85">恢复视力R：</label>
                    <input type="text" name="recoverEyeSightR" id="j_customer_recoverEyeSightR" value="${customer.recoverEyeSightR}"  data-rule="required" size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_recoverEyeSightL" class="control-label x85">恢复视力L：</label>
                    <input type="text" name="recoverEyeSightL" id="j_customer_recoverEyeSightL" value="${customer.recoverEyeSightL}" data-rule="required" size="15" readonly>
                </td>
            </tr>
            <tr>
                <td>
                    <label for="j_customer_definR" class="control-label x85">清晰度R：</label>
                    <input type="text" name="definR" id="j_customer_definR" value="${customer.definR}" data-rule="required" size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_definL" class="control-label x85">清晰度L：</label>
                    <input type="text" name="definL" id="j_customer_definL" value="${customer.definL}" size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_eyeControl" class="control-label x85">调节力：</label>
                    <input type="text" name="eyeControl" id="j_customer_eyeControl" value="${customer.eyeControl}"  size="15" readonly>
                </td>
                <td>
                    <label for="j_customer_eyeStrength" class="control-label x85">眼肌耐受力：</label>
                    <input type="text" name="eyeStrength" id="j_customer_eyeStrength" value="${customer.eyeStrength}" size="15" readonly>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <label for="j_customer_hasDisease" class="control-label x85">有无眼疾或其他过敏史：</label>
                    <textarea name="hasDisease" id="j_customer_hasDisease" data-toggle="autoheight" cols="60" rows="1" readonly>${customer.hasDisease}</textarea>
                </td>
            </tr>
            </tbody>
        </table>
