    ...
    <form action="${ctx}/cus//save" class="pageForm" data-toggle="validate">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="text" onclick="sumPoint()" name="naireResult" id="naireResult" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="firstResult" id="firstResult" value="" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="seccondResult" id="seccondResult" value="" />
                </td>
            </tr>
            <tr>
                <td>
