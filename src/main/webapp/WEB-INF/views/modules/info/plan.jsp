...
<script type="text/javascript">
    $('#user-datagrid-json').datagrid({
        columns: [
            ...
            return '<a href="${ctx}/info/plan/manage?id='+value+'" data-toggle="dialog" data-width="830" data-height="230"data-mask="true" data-type="POST" data-title="账号修改" class="btn btn-blue">修改</a>'
            },
            edit:false,
            add:false
            }
        ...
        toolbarCustom 	: 	'<a href="${ctx}/info/plan/manage" data-toggle="dialog" data-id="" data-width="830" data-height="230" data-mask="true" data-type="POST" data-title="新增账号" class="btn btn-blue">新增角色</a>  ',//[可选] 自定义的html内容或jQuery DOM对象，支持带返回值函数。
