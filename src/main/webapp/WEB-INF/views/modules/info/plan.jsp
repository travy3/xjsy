...
<script type="text/javascript">
    $('#plan-datagrid-${uuid}').datagrid({
        ...
        toolbarCustom 	: 	'<a href="${ctx}/info/plan/form" data-toggle="dialog" data-id="" data-width="830" data-height="610" data-mask="true" data-type="POST" data-title="新增" class="btn btn-blue">新增</a>  ',//[可选] 自定义的html内容或jQuery DOM对象，支持带返回值函数。
...
<div class="bjui-pageContent tableContent">
    <div style="height:100%; width:100%;">
        <table id="plan-datagrid-${uuid}" data-width="100%" class="table table-bordered">
        </table>
        <br>
    </div>
</div>
