        ...
        <table class="table table-condensed table-hover">
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="name" id="j_dialog_name" value="${plan.name}" data-rule="required"
                           size="20">
                </td>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="levelNo" id="j_dialog_levelNo" value="${plan.levelNo}"
                           data-rule="required;number" size="20">
                </td>
                <td>
                    <label for="j_dialog_orderNo" class="control-label x90">期数：</label>
                    <input type="text" name="orderNo" id="j_dialog_orderNo" value="${plan.orderNo}"
                           data-rule="required;number" size="20">
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="text" name="remarks" id="j_dialog_remarks" value="${plan.remarks}" data-rule="required"
                           size="20">
                </td>
            </tr>
            </tbody>
...
<script>
     ...
     * orderNo检车 未完待续
     */
    function checkOrderNoisRight() {
        debugger;
        var orderNo =$('#orderNo').val();
        var eyeType = $('#eyeType').val();
        var levelNo = $('#levelNo').val();
        if (orderNo && eyeType && levelNo) {
            $.ajax('${ctx}/info/plan/checkOrderNoisRight?orderNo=' + orderNo + '&eyeType=' + eyeType + '&levelNo=' + levelNo, {}).done(function (data) {
                debugger;
                var flag = data;
                if (flag) {
                    alert
